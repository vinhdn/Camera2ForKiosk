...
public class CameraKitView extends GestureLayout {
    ...
    public interface PreviewCallback {
         ...
         * @param image
         */
        void onImage(CameraKitView view, Bitmap image);
     ...
     * @param callback
     */
    public void captureImage(final FrameCallback callback) {
        mCameraPreview.capturePhoto(new CameraPreview.PhotoCallback() {
            ...
            public void onCapture(@NotNull final byte[] jpeg) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        callback.onFrame(CameraKitView.this, jpeg);
                    }
                });
            }
        });
    ...
    public void setPreviewCallback(final PreviewCallback callback) {
        mCameraPreview.setPreviewListener(new CameraPreview.PreviewCallback() {
            @Override
            public void onPreview(@NotNull final Bitmap image) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        callback.onImage(CameraKitView.this, image);
                    }
                });
            }
        });
